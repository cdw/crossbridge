...
We produce binding rate constants in the same fashion, but in adapting them for multi-spring cross-bridges, split the process into two steps: diffusion of the cross-bridge head to a new location, followed by calculating binding probability at the new location. 

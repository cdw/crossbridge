...
This relationship is shown in Figure~\ref{fig_kinetics_contours}A and B, where the axial offset of the 4sXB or 2sXB model's lowest energy point is more than 3 nm greater at a lattice spacing of 32 nm $d_{10}$ than at a lattice spacing of 38 nm $d_{10}$. 
The positions where cross-bridges are most likely to bind shift to smaller axial offsets at larger lattice spacings, decreasing how extended a cross-bridge is likely to be upon binding (Fig~\ref{fig_kinetics_contours}C-D). 
...
Similarly, as lattice spacing increases, decreases in the axial offset of the power stroke rate constant inflection point cause the size of the power stroke to change with lattice spacing (Fig~\ref{fig_kinetics_contours}E-F). %TODO: This would be nice to split, if possible.
...
Experimental measurements of step size vary, and it has been postulated that this is due to more than experimental error, but to our knowledge these results are the first prediction of a step size that varies with lattice spacing \cite{Brenner2006}.
...
%\begin{figure}[!ht]
%    \begin{center}
%    \includegraphics[width=4.86in]{../imgs/CoverFigureLattice.png}
%    \caption{ \textbf{PROPOSED COVER FIGURE (COMMENT OUT BEFORE UPLOADING)}
%        Myofilament lattice with multi-dimensional energy profile of a single myosin head.
%        \label{fig_cover_figure}
%           }
%    \end{center}
%\end{figure}

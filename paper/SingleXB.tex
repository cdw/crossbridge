...
% Intro paragraph (end)
% TODO: This intro paragraph may be cut for length if needed.
...
The force a cross-bridge produces trends from initial negative values at compressed lattice spacings, to spacings where little force is produced, to very positive values at expanded lattice spacings (Fig.~\ref{fig_forces}). 
...
This 2sXB is contrasted to the alternative geometry used in \citet{Schoenberg1980a} and \citet{Schoenberg1980b}, where an extensional spring representing the S2 domain is joined, via a torsional spring, to a rigid rod representing the S1 domain.

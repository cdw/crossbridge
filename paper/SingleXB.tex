...
The detachment rate and the other cross-bridge kinetic rates remain close to those of the 1sXB, given that the kinetic rates of the multi-spring cross-bridges are based not on axial position but on the free energy of the cross-bridge in multiple dimensions.  % TODO: Re-read this sentence at some point to make sure it still parses.
% paragraph (end)
...
Interestingly, we were able to adjust the parameters of the 2sXB model to give results that are similar to the 4sXB model, permitting a more computationally frugal approach to including a multi-dimensional cross-bridge. % TODO : Re-read at some point to make sure it still parses well.
...
\begin{figure}[ht]
    ...
    \caption{ \textbf{Cross-bridge types and kinetic scheme.} 
        ...
        (A) The 1sXB introduced in \protect\citep{Huxley1957}. 

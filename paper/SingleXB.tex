...
The three states represented in the kinetic scheme are (1) an unbound state: Myosin-$\mathrm{ADP.P}_i$ (2) a loosely-bound state:Actin-Myosin-$\mathrm{ADP.P}_i$ and (3) a force-generating post-power stroke state: Actin-Myosin-ADP (Fig~\ref{fig_xb_types}D). 

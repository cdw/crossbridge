...
class xNxG():
    ...
    def bop(self):
        ...
        self.set_conv_and_head_from_segments(N, G)
...
# Save it
dataout = open('trans01_xNxG.pkl', 'wb')
pkl.dump([xb, trials, x_locs, y_locs, rates], dataout, 2)
dataout.close()
# Plot the output
contour.title = ("0->1 transition rate of an xNxG crossbridge as a \n" \

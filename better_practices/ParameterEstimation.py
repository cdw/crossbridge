...
def main():
    ...
    # reasonable value for the resting radial offset of our crossbridge heads.
    #
    ...
    # domain (LCD) and the axial axis goes from 125 degrees to 70 degrees. 
    #
    # If we assume that the catalytic domain (CD) is remaining radially 
    # oriented during this shift in LCD angle, this means that the angle 
    # between the LCD and the CD goes from 215 degrees to 160 degrees
    #
    #
